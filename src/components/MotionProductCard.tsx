...
const MotionProductCard: React.FC<MotionProductCardProps> = ({
	...
	return (
		...
		>
			...
			<div className="relative h-75 sm:h-48 md:h-56 lg:h-64 flex items-center justify-center overflow-hidden transition-colors duration-300 rounded-t-lg sm:bg-black">
				<Image
					src={

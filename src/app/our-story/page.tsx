							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-stretch">
								...
								>
									...
									<p className="text-base md:text-lg leading-relaxed">
										...
										founded by 2 individuals from very different backgrounds.
										One of us with a deep love of matcha since a very young age
										and the other started off his matcha journey after a simple
										sip which changed his perspective of Matcha.
									</p>
								</motion.div>
							</div>
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-stretch">
								...
								>
									...
									<p className="text-base md:text-lg leading-relaxed">
										...
										matcha can offer, we explored matcha across Japan and China
										in search of quality products that we can share with you at
										an affordable price, in a time where Matcha has gained
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-stretch">
								...
								>
									...
									<p className="text-base md:text-lg leading-relaxed">
										...
										ensure the high quality of matcha we promise to our
										community.
									</p>
								</motion.div>
							</div>
